...
public class SmoothImageView extends PhotoView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mStatus == Status.STATE_OUT || mStatus == Status.STATE_IN) {
            ...
            Log.e("onDraw"," animTransform.scale:"+ animTransform.scale);
//            Log.e("onDraw"," animTransform.scale:"+ animTransform.scale);
    ...
    private void startTransform() {
        ...
        if (mStatus == Status.STATE_IN) {
            ...
            PropertyValuesHolder widthHolder = PropertyValuesHolder.ofFloat("animWidth", startTransform.width/2, endTransform.width/2);
