...
public class NewAudienceAdapter extends BaseAdapter {
    ...
    public NewAudienceAdapter(Context context, ArrayList<AudienceVideo> audiences, OnAudienceButtonClickListener listener) {
